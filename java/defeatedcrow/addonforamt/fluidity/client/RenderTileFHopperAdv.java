...
public class RenderTileFHopperAdv extends TileEntitySpecialRenderer {

	private static final ResourceLocation thisTex = new ResourceLocation("fluiditydc:textures/entity/fluid_hopper_adv.png");
	public static RenderTileFHopperAdv renderer;
	private ModelFluidHopper thisModel = new ModelFluidHopper();
	
	public void renderTileEntityAt(TileAdvFluidHopper par1Tile, double par2, double par4, double par6, float par8)
    {
        this.setRotation(par1Tile, (float)par2, (float)par4, (float)par6);
    }
	
	private void setRotation(TileAdvFluidHopper par1Tile, float par2, float par4, float par6) {
		
		byte l = (byte) par1Tile.getBlockMetadata();
		float round = l * 90.0F - 90.0F;
		
		float valve = 0.0F;
		if (par1Tile.isActive()) valve = 90.0F;
        ...
        thisModel.renderSolenoidValve((Entity)null, 0.0F, 0.0F, 0.0F, valve, 0.0F, 0.0625F);
    ...
    {
        this.renderTileEntityAt((TileAdvFluidHopper)par1TileEntity, par2, par4, par6, par8);
    }
}
