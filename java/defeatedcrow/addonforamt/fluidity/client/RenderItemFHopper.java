...
public class RenderItemFHopper implements IItemRenderer{
	
	private static final ResourceLocation resource = new ResourceLocation("fluiditydc:textures/entity/fluid_hopper.png");
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		if (canRendering(item, type))
		{
	        ...
	        model.renderValve((Entity)null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
